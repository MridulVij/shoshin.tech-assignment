...
class CustomTask1Widget extends StatelessWidget {
  const CustomTask1Widget({super.key});
                      ...
                      child: Stack(
                        children: [
                          ...
                          ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: Image.network(
                                tasksModel.thumbnail ?? errorImage,
                                fit: BoxFit.fill),
                          ),
                        ],
                      ),
...
class CustomTask2Widget extends StatelessWidget {
  const CustomTask2Widget({super.key});
                        ...
                        child: Row(
                          children: [
                            ClipRRect(
                              borderRadius: BorderRadius.circular(20),
                              child: Image.network(
                                tasksModel.brand?.logo ?? errorImage,
                                fit: BoxFit.contain,
                                height: 70,
                                width: 70,
                              ),
                            ...
                            Padding(
                              padding: const EdgeInsets.only(
                                  top: 40, bottom: 0, left: 140, right: 0),
                              child: Text(
                                tasksModel.totalLead!,
                                style: TextStyle(
                                    color:
